       ...
       xhttp.onreadystatechange = function()
      {
          ...
          {   // Response Code
              ...
              if(len_task>0)
              {
                  ...
                  {
                    DisplayMembers(result['members'],result['remaining']);
                  }
                  else
                  {
                    document.getElementById('remaining').innerHTML = "<span style="+'"color:red"'+">Task Assignment Complete</span>";
                  }
...
/*
    Usage : Display the Member List Fetched from BACKEND
    Return : None
    Parameters : members list , remaining members to be assigned
*/
function DisplayMembers(member_fetch,remaining)
{
  var member_rows=0;
  var cell=0;
  ...
  // Append rows in member_table containing Add/Delete Icon and Member Id
      ...
      for(var member=0;member<len_members;member++)
    {
      ...
      document.getElementById('remaining').innerHTML = "Choose "+remaining+" More Members ";
    }
    else
    {
        document.getElementById('remaining').innerHTML = "<span style="+'"color:red"'+">All Members Assigned to this Task</span>";
    }
          ...
          var xhttp = new XMLHttpRequest();
              ...
              xhttp.onreadystatechange = function() {
               ...
               {  // Response Code
                   ...
                   */
                  alert(result[0]);
                  SelectTask(select_task_id,select_pm_id);
               }
        };
